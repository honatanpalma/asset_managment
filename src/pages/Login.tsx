            ...
            <form action="#" className="space-y-5" method="POST">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input className="w-full pl-12 pr-4 py-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-slate-900 dark:text-slate-100 outline-none" placeholder="name@company.com" required type="email" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input className="w-full pl-12 pr-12 py-3.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-slate-900 dark:text-slate-100 outline-none" placeholder="••••••••" required type="password" />
              ...
              <Link to="/secure-access" className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-4 px-6 rounded-lg transition-colors flex items-center justify-center gap-2 group shadow-lg shadow-primary/20">
                <span>Sign In</span>
